...
## Topics
- AI Fundamentals and Advanced Topics
...
- [ ] Probability & Statistics
    - [ ] Combined Course @[Coursera](https://www.coursera.org/learn/machine-learning-probability-and-statistics)
...
- [ ] LLM Course - @[HuggingFace](https://huggingface.co/learn/llm-course)
- [ ] Post Training LLMs - @[HuggingFace](https://huggingface.co/learn/smol-course)
- [ ] Agents Course - @[HuggingFace](https://huggingface.co/learn/agents-course)
- [ ] MCP Course - @[HuggingFace](https://huggingface.co/learn/mcp-course)
- [ ] Cheatsheets - @[Stanford](https://github.com/pavankumarbalijepalli/Stanford-AI-Cheatsheets/tree/main)

__Optional but cool:__
- [ ] Finetuning Docs - @[Unsloth](https://docs.unsloth.ai/)
- [ ] AI Cookbook - @[HuggingFace](https://huggingface.co/learn/cookbook)
- [ ] Robotics Course - @[HuggingFace](https://huggingface.co/learn/robotics-course)
...
- Deeplearning.ai
    ...
    - [ ] [Large Language Models Semantic Search](https://www.deeplearning.ai/short-courses/large-language-models-semantic-search)
    - [ ] [Finetuning Large Language Models](https://www.deeplearning.ai/short-courses/finetuning-large-language-models)
    - [ ] [Microsoft Semantic Kernel](https://www.deeplearning.ai/short-courses/microsoft-semantic-kernel)
    - [ ] [Google Cloud Vertex Ai](https://www.deeplearning.ai/short-courses/google-cloud-vertex-ai)
    - [ ] [Pair Programming Llm](https://www.deeplearning.ai/short-courses/pair-programming-llm)
    - [ ] [Functions Tools Agents Langchain](https://www.deeplearning.ai/short-courses/functions-tools-agents-langchain)
    - [ ] [Vector Databases Embeddings Applications](https://www.deeplearning.ai/short-courses/vector-databases-embeddings-applications)
    - [ ] [Quality Safety Llm Applications](https://www.deeplearning.ai/short-courses/quality-safety-llm-applications)
    - [ ] [Building Evaluating Advanced Rag](https://www.deeplearning.ai/short-courses/building-evaluating-advanced-rag)
    ...
    - [ ] [Open Source Models Hugging Face](https://www.deeplearning.ai/short-courses/open-source-models-hugging-face)
    ...
    - [ ] [Intro To Federated Learning](https://www.deeplearning.ai/short-courses/intro-to-federated-learning)
    ...
    - [ ] [Building An Ai Powered Game](https://www.deeplearning.ai/short-courses/building-an-ai-powered-game)
    ...
    - [ ] [Build Long Context Ai Apps With Jamba](https://www.deeplearning.ai/short-courses/build-long-context-ai-apps-with-jamba)
    ...
    - [ ] [Event Driven Agentic Document Workflows](https://www.deeplearning.ai/short-courses/event-driven-agentic-document-workflows)
    ...
    - [ ] [Building Ai Voice Agents For Production](https://www.deeplearning.ai/short-courses/building-ai-voice-agents-for-production)
    ...
    - [ ] [Reinforcement Fine Tuning Llms Grpo](https://www.deeplearning.ai/short-courses/reinforcement-fine-tuning-llms-grpo)
    - [ ] [Dspy Build Optimize Agentic Apps](https://www.deeplearning.ai/short-courses/dspy-build-optimize-agentic-apps)
    ...
    - [ ] [Building With Llama 4](https://www.deeplearning.ai/short-courses/building-with-llama-4)
    - [ ] [Acp Agent Communication Protocol](https://www.deeplearning.ai/short-courses/acp-agent-communication-protocol)
    ...
    - [ ] [Agentic Knowledge Graph Construction](https://www.deeplearning.ai/short-courses/agentic-knowledge-graph-construction)
    ...
    - [ ] [Build Ai Apps With Mcp Server Working With Box Files](https://www.deeplearning.ai/short-courses/build-ai-apps-with-mcp-server-working-with-box-files)
    - [ ] [Building And Evaluating Data Agents](https://www.deeplearning.ai/short-courses/building-and-evaluating-data-agents)
    - [ ] [Building Live Voice Agents With Googles Adk](https://www.deeplearning.ai/short-courses/building-live-voice-agents-with-googles-adk)
    - [ ] [Governing Ai Agents](https://www.deeplearning.ai/short-courses/governing-ai-agents)
    - [ ] [Jupyter Ai Coding In Notebooks](https://www.deeplearning.ai/short-courses/jupyter-ai-coding-in-notebooks)
- LangGraph Academy
    ...
    - [ ] [Ambient Agents - Project](https://academy.langchain.com/courses/ambient-agents)
    - [ ] [Deep Research Agent - Project](https://academy.langchain.com/courses/deep-research-with-langgraph)
